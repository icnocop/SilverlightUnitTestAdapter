// <copyright file="TestRunTypeResultSummaryRunInfos.cs" company="Niels Hebling, Rami Abughazaleh, and contributors">
...
namespace SilverlightUnitTestAdapter
{
    ...
    public class TestRunTypeResultSummaryRunInfos
    {
