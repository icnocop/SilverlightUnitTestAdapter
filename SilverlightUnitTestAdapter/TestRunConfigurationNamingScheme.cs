// <copyright file="TestRunConfigurationNamingScheme.cs" company="Niels Hebling, Rami Abughazaleh, and contributors">
...
namespace SilverlightUnitTestAdapter
{
    ...
    public class TestRunConfigurationNamingScheme
    {
