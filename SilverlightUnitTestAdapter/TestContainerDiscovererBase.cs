namespace SilverlightUnitTestAdapter
{
    ...
    using SilverlightUnitTestAdapter.Extensions;
    ...
    /// </summary>
    public abstract class TestContainerDiscovererBase : ITestContainerDiscoverer, IDisposable, IVsSolutionEvents, IVsHierarchyEvents
    {
        ...
        protected TestContainerDiscovererBase(IServiceProvider serviceProvider)
        {
        ...
        void UpdateTestContainers()
        {
            lock (this) // HACK: Make all this better
            {
                ...
                cachedTestContainers = solutionService
                    .GetProjects()
                    .Select(p => p.GetProjectOutputFilePath())
