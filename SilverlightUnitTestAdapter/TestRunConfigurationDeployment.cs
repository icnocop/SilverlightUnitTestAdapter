// <copyright file="TestRunConfigurationDeployment.cs" company="Niels Hebling, Rami Abughazaleh, and contributors">
...
namespace SilverlightUnitTestAdapter
{
    ...
    public class TestRunConfigurationDeployment : DeploymentItemsType
    {
