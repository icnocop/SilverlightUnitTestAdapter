// <copyright file="LoadTestTypeScenariosScenarioBrowserMix.cs" company="Niels Hebling, Rami Abughazaleh, and contributors">
...
namespace SilverlightUnitTestAdapter
{
    ...
    public class LoadTestTypeScenariosScenarioBrowserMix
    {
