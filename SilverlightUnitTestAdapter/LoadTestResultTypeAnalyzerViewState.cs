// <copyright file="LoadTestResultTypeAnalyzerViewState.cs" company="Niels Hebling, Rami Abughazaleh, and contributors">
...
namespace SilverlightUnitTestAdapter
{
    ...
    public class LoadTestResultTypeAnalyzerViewState
    {
