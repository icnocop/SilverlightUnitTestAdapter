// <copyright file="RuntimeResolutionDirectoryType.cs" company="Niels Hebling, Rami Abughazaleh, and contributors">
...
namespace SilverlightUnitTestAdapter
{
    ...
    public class RuntimeResolutionDirectoryType : ResolutionDirectoryType
    {
